...
export class ApiContextState {
    ...
    public constructor(url:string, user: string | undefined, password: string | undefined) {
...
export const ApiContext = React.createContext<ApiContextState>(new ApiContextState("","",""));
