...
export const ContactControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        _delete: async (contactId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        create: async (contact: Contact, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        update: async (contactId: string, contact: Contact, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'contactId' is not null or undefined
...
export const ContactControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async _delete(contactId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator._delete(contactId, options);
         ...
         * @throws {RequiredError}
         */
        async create(contact: Contact, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Contact>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.create(contact, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async get(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Contact>>> {
         ...
         * @throws {RequiredError}
         */
        async update(contactId: string, contact: Contact, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Contact>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.update(contactId, contact, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ContactControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        _delete(contactId: string, options?: any): AxiosPromise<void> {
            return localVarFp._delete(contactId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {Contact} contact 
        ...
        create(contact: Contact, options?: any): AxiosPromise<Contact> {
            return localVarFp.create(contact, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        update(contactId: string, contact: Contact, options?: any): AxiosPromise<Contact> {
            return localVarFp.update(contactId, contact, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ContactControllerApi extends BaseAPI {
     ...
     */
    public _delete(requestParameters: ContactControllerApiDeleteRequest, options?: AxiosRequestConfig) {
        return ContactControllerApiFp(this.configuration)._delete(requestParameters.contactId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactControllerApi
     */
    public create(requestParameters: ContactControllerApiCreateRequest, options?: AxiosRequestConfig) {
        return ContactControllerApiFp(this.configuration).create(requestParameters.contact, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public get(options?: AxiosRequestConfig) {
        return ContactControllerApiFp(this.configuration).get(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactControllerApi
     */
    public update(requestParameters: ContactControllerApiUpdateRequest, options?: AxiosRequestConfig) {
        return ContactControllerApiFp(this.configuration).update(requestParameters.contactId, requestParameters.contact, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export class PublicControllerApi extends BaseAPI {
    ...
    public ping(options?: AxiosRequestConfig) {
        return PublicControllerApiFp(this.configuration).ping(options).then((request) => request(this.axios, this.basePath));
    }
}
